...
export default function ProductDetailPage() {
  const { crops, addToCart, farmers, loading, user } = useAppContext();
  ...
  const breadcrumbHomeLink = user?.role === 'farmer' ? '/farmer/dashboard' : '/buyer/dashboard';
          ...
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink asChild>
                <Link href={breadcrumbHomeLink}>Home</Link>
              </BreadcrumbLink>
            </BreadcrumbItem>
            {user?.role === 'buyer' && (
                <>
